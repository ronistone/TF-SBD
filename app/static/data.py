estados = [
('','Selecione um estado'),('AC','Acre'),('AL','Alagoas'),('AM','Amazonas'),('AP','Amapá'),('BA','Bahia'),('CE','Ceará'),('DF','Distrito Federal'),('ES','Espírito Santo'),('GO','Goiás'),('MA','Maranhão'),('MG','Minas Gerais'),('MS','Mato Grosso do Sul'),('MT','Mato Grosso'),('PA','Pará'),('PB','Paraíba'),('PE','Pernambuco'),('PI','Piauí'),('PR','Paraná'),('RJ','Rio de Janeiro'),('RN','Rio Grande do Norte'),('RO','Rondônia'),('RR','Roraima'),('RS','Rio Grande do Sul'),('SC','Santa Catarina'),('SP','São Paulo'),('SE','Sergipe'),('TO','Tocantins'),]
cidades = [
('',''),
...
('Atalanta','Atalanta'),
('Aurora','Aurora'),
('Balneáreo Piçarras','Balneáreo Piçarras'),
...
('Couto de Magalhães','Couto de Magalhães'),
...
('São Valério da Natividade','São Valério da Natividade'),
